...
set(STM32_FETCH_CUBE_VERSIONS  v1.11.2 v1.8.4  v1.9.3  v1.11.2 v1.27.0  v1.16.1 v1.4.1  v1.4.0  v1.9.0   v1.12.0 v1.10.3 v1.17.0 v1.4.0 1.5.0  v1.0.0 v1.12.0 v1.1.0)
set(STM32_FETCH_CMSIS_VERSIONS v2.3.5  v4.3.3  v2.2.5  v2.3.5  v2.6.8   v1.2.6  v1.4.0  v1.2.1  v1.10.0  v1.9.1  v2.3.2  v1.7.1  v1.0.4 cube   v1.0.0 v1.9.0  v1.1.0)
set(STM32_FETCH_HAL_VERSIONS   v1.7.5  v1.1.8  v1.2.7  v1.5.5  v1.8.0   v1.2.9  v1.4.1  v1.2.1  v1.10.0  v1.10.4 v1.4.4  v1.13.0 v1.0.4 cube   v1.0.0 v1.9.0  v1.1.0)

FetchContent_Declare(
    STM32-CMSIS
    GIT_REPOSITORY https://gitee.com/mirrors_STMicroelectronics/cmsis_core/
    GIT_TAG        v5.6.0
    GIT_PROGRESS   TRUE
)
...
foreach(FAMILY ${STM32_FETCH_FAMILIES})
	...
	FetchContent_Declare(
		STM32Cube${FAMILY}
		GIT_REPOSITORY https://gitee.com/mirrors_STMicroelectronics/STM32Cube${FAMILY}/
    ...
    if(CMSIS_VERSION STREQUAL cube)
        ...
        FetchContent_Declare(
            STM32-CMSIS-${FAMILY}
            GIT_REPOSITORY https://gitee.com/mirrors_STMicroelectronics/cmsis_device_${FAMILY_L}/
    ...
    if(HAL_VERSION STREQUAL cube)
        ...
        FetchContent_Declare(
            STM32-HAL-${FAMILY}
            GIT_REPOSITORY https://gitee.com/mirrors_STMicroelectronics/stm32${FAMILY_L}xx_hal_driver/
            GIT_TAG        ${HAL_VERSION}
            GIT_PROGRESS   TRUE
        )
    endif()
