...
#define		OLED_SSD1306_SCLK_IO_INIT		(Set_Bit(P8DIR,OLED_SSD1306_SCLK_PIN_NUM))
#define		OLED_SCLK_Set()			        (Set_Bit(P8OUT,OLED_SSD1306_SCLK_PIN_NUM))
#define		OLED_SCLK_Clr()				(Clr_Bit(P8OUT,OLED_SSD1306_SCLK_PIN_NUM))
...
#define		OLED_SSD1306_SDIN_IO_INIT		(Set_Bit(P8DIR,OLED_SSD1306_SDIN_PIN_NUM))
#define		OLED_SDIN_Set()				(Set_Bit(P8OUT,OLED_SSD1306_SDIN_PIN_NUM))
#define		OLED_SDIN_Clr()			        (Clr_Bit(P8OUT,OLED_SSD1306_SDIN_PIN_NUM))
...
#define		OLED_DC_Clr() 				(Clr_Bit(P9OUT,OLED_SSD1306_DC_PIN_NUM))
...
#define		OLED_SSD1306_CE_IO_INIT			(Set_Bit(P9DIR,OLED_SSD1306_CE_PIN_NUM))
#define		OLED_CS_Set()				(Set_Bit(P9OUT,OLED_SSD1306_CE_PIN_NUM))
#define		OLED_CS_Clr()				(Clr_Bit(P9OUT,OLED_SSD1306_CE_PIN_NUM))
